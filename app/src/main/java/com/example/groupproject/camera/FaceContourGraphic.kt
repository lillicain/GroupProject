...
//        val x = face.bounds.centerX().toFloat()
//        val y = face.bounds.centerY().toFloat()
//        FaceDimensions(
//            x = x,
//            y = y,
...
//            left = x - face.bounds.width() / 2.0f,
//            top = y - face.bounds.height() / 2.0f,
//            right = x + face.bounds.width() / 2.0f,
//            bottom = y + face.bounds.height() / 2.0f,
//        )
//    }
//}
